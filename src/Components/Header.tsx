...
function Header() {
    return (
        <div className="w-full h-16 bg-gray-60 sticky top-0 z-50 bg-gray-100 flex items-center justify-center text-[#00854A] text-base lg:text-[22px] font-bold barlow-font">
